                  ...
                  <table class="striped">
                    ...
                    @foreach($sensors as $sensor)
                      <tr>
                        ...
                        <td><span class="green-text text-darken-2">{{ $sensor->temperature }}</span> <b> °C Comfortable</b> </td>
                        @else
                        ...
                        <td><b><span class="red-text text-darken-2">{{ $sensor->humidity }}</span> % Comfortable</b></td>
